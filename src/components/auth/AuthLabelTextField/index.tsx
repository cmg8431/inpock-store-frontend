...
interface AuthLabelTextFieldProps extends InputHTMLAttributes<HTMLInputElement> {
  className?: string;
  importance?: boolean;
}

export const AuthLabelTextField = React.forwardRef<HTMLInputElement, AuthLabelTextFieldProps>(
